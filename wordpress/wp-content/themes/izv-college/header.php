...
<!-- Mirrored from psdconverthtml.com/live/edupress/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Feb 2017 17:19:26 GMT -->
<head>
    ...
    <!-- RESPONSIVE STYLES -->
    <link rel="stylesheet" type="text/css" href="<?=get_template_directory_uri()?>/assets/css/responsive.css">
    <!-- COLORS STYLES -->
    <link rel="stylesheet" type="text/css" href="<?=get_template_directory_uri()?>/assets/css/colors.css">
    <!-- CUSTOM STYLES -->
                    ...
                    <div class="container-full">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                                                ...
                                                <div class="row-fluid">
                                                            ...
                                                            <div class="pager">
                                                                <div class="post clearfix">
                                                                    <a href="course-single.html">
                                                                        <img alt="" src="<?=get_template_directory_uri()?>/assets/upload/pager_04.jpg" class="img-responsive alignleft">
                                                                ...
                                                                <div class="post clearfix">
                                                                    <a href="course-single.html">
                                                                        <img alt="" src="<?=get_template_directory_uri()?>/assets/upload/pager_05.jpg" class="img-responsive alignleft">
                                                                ...
                                                                <div class="post clearfix">
                                                                    <a href="course-single.html">
                                                                        <img alt="" src="<?=get_template_directory_uri()?>/assets/upload/pager_06.jpg" class="img-responsive alignleft">
                                                    ...
                                                    <div class="col-md-3 hidden-sm hidden-xs">
                                                        <div class="menu-widget">
                                                            <a href="#"><img src="<?=get_template_directory_uri()?>/assets/upload/banner_01.jpg" alt="" class="img-responsive"></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="btn btn-primary"><a title="Join for free" href="member-register.html">Join us</a></li>
                            </ul>
                            <!-- end dropdown -->
                        </div>
                        <!--/.nav-collapse -->
