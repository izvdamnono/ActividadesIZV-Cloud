    ...
    ********************************************** -->
    <script src="<?=get_template_directory_uri()?>/assets/js/all.js"></script>
    <script src="<?=get_template_directory_uri()?>/assets/js/custom.js"></script>

</body>

<!-- Mirrored from psdconverthtml.com/live/edupress/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Feb 2017 17:20:03 GMT -->
</html>