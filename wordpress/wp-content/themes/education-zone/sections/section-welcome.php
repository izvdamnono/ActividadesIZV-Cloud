    ...
    if( $first_stats_number || $first_stats_title || $second_stats_number || $second_stats_title || $third_stats_number || $third_stats_title || $fourth_stats_number || $fourth_stats_title ){ ?>
        ...
        <div class="row">
            ...
            <?php if( $first_stats_number && $first_stats_title ){ ?>
            	<div class="col">
            		<div class="text">
            			<h3 class="number"><?php echo absint( $first_stats_number ); ?></h3>
            ...
            <?php } if( $second_stats_number && $second_stats_title ){ ?>
            	<div class="col">
            		<div class="text">
            			<h3 class="number"><?php echo absint( $second_stats_number ); ?></h3>
            ...
            <?php } if( $third_stats_number && $third_stats_title ){ ?>
            	<div class="col">
            		<div class="text">
            			<h3 class="number"><?php echo absint( $third_stats_number ); ?></h3>
            ...
            <?php }  if( $fourth_stats_number && $fourth_stats_title ){ ?>
            	<div class="col">
            		<div class="text">
            			<h3 class="number"><?php echo absint( $fourth_stats_number ); ?></h3>
