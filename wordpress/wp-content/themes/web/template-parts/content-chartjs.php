...
<article data-id="<?=$post->ID?>">
    ...
    <div class="about-two">
        ...
        <?php } ?>
    	<p><?= __("By", "web") ?> <a href="<?= $get_author_posts_url ?>"><?=$get_author_name?></a> on <a href="<?= $get_the_time_link ?>"><?= $get_the_time ?></a> <a href="<?= $get_comments_link ?>"><?= __("Comments", "web") ?>(<?= $get_comments_number ?>)</a></p>
        
        <div class="entry the_content">
            <?php the_content(); ?>
        </div>
